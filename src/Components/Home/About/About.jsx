...
const About = () => {
    return (
        <div id='About' className="px-4 pb-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-0">
            <h1 className='text-center text-5xl font-bold lg:mb-10 mb-4 text-orange-700'>About</h1>
